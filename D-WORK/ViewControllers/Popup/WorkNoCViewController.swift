...
class WorkNoCViewController: UIViewController {
...
//        }
        if let ordNm = tfordNm.text {
            workReportworkNoAListRequest.orderNm = ordNm
        }
        hud.textLabel.text = "Loading"
        hud.show(in: self.view)
        print("workReportworkNoAListRequest : \(workReportworkNoAListRequest)")
        
        ApiService.request(router: WorkReportApi.workNoCList(param: workReportworkNoAListRequest), success: { (response: ApiResponse<WorkReportworkNoAListResponse>) in
            self.hud.dismiss()
...
extension WorkNoCViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 0:
            ...
            cell.lblcsNum.text = "수주번호"
            cell.lblcustomNm.text = "수주처"
            cell.lblordNm.text = "수주명"
...
//        print("selected : \(indexPath.row)")
        ...
        dismiss(animated: true, completion: {
            if let previousViewController = self.previousViewController as? WorkReportRegisterViewController {
                ...
                print("item : \(item)")
                previousViewController.getwWrkNoCListFromPopup(workNoAListItem: item)
            }
        })
