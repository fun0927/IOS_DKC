//
//  DivListPopupViewController.swift
//  D-WORK
//
...
class DivListPopupViewController: UIViewController, DropDownViewProtocol {
...
//            print("error : \(error)")
    ...
    func getUpDeptList(){
        ...
        ApiService.request(router: CommonApi.upDeptList(param: UpDeptListRequest(divCdParam: selectedDivCd)) , success: { (response: ApiResponse<UpDeptListResponse>) in
            self.hud.dismiss()
//            print("response : \(response)")
...
extension DivListPopupViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
